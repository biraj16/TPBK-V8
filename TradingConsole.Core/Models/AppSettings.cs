...
namespace TradingConsole.Core.Models
{
    ...
    public class StrategySettings
    {
        ...
        public StrategySettings()
        {
            TrendingBullDrivers = new ObservableCollection<SignalDriver>
            {
                ...
                new SignalDriver("Price Above GEX Flip Point (Bullish Hedging Flow)", 5), // NEW
                new SignalDriver("Net GEX is Negative (Market Makers are Short Gamma, Volatility Amplified)", 4) // NEW
            };
            ...
            TrendingBearDrivers = new ObservableCollection<SignalDriver>
            {
                ...
                new SignalDriver("Price Below GEX Flip Point (Bearish Hedging Flow)", -5), // NEW
                new SignalDriver("Price Approaching Max GEX Level (Pinning Risk)", -3) // NEW
            };
    ...
    {
        public Dictionary<string, double> NiftyHeavyweights { get; set; }
        ...
        public AppSettings()
        {
            NiftyHeavyweights = new Dictionary<string, double>
            {
                { "RELIANCE", 11.5 },
                { "HDFCBANK", 8.5 },
                { "ICICIBANK", 7.9 },
